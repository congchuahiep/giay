import deserializerMarkdownAndInsert from "@/features/editor/plugins/clipboard/deserializeMarkdown.ts";
import { serializeFragmentToMarkdown } from "@/features/editor/plugins/clipboard/serializeMarkdown.ts";
import { serializeFragmentHtml } from "./serializeHtml.ts";
import { useCallback } from "react";
import { Editor } from "slate";
import { deserializeHtmlAndInsert } from "@/features/editor/plugins/clipboard/deserializeHtml.ts";
