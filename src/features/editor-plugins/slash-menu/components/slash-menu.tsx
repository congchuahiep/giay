...
import {
	OpenSlashMenuShortcutExtension,
	SlashMenuShortcutExtension,
} from "../shortcut-extension";
import { SLASH_MENU_ITEMS } from "../slash-menu-items";
import { useSlashMenu } from "../stores";
...
export default function SlashMenu() {
	...
	useRegisterShortcuts(slashMenuShortcutContext, [SlashMenuShortcutExtension]);
